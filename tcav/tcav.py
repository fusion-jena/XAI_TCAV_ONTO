...
class TCAV(object):
  ...
  def run(self, num_workers=0, run_parallel=False, overwrite=False, return_proto=False):
   ...
   # print('I am in Tcav run method')
    ...
    if run_parallel:
      ...
      #  print('I am in run method - want to understand run_examples')
  ...
  def _run_single_set(self, param, overwrite=False, run_parallel=False):
    ...
    """
   # print(' I am in TCAV _run_single_set')
    bottleneck = param.bottleneck
   # print('I am in TCAV _run_single_set - param.bottleneck')
   # print(bottleneck)
    concepts = param.concepts
   # print('I am in TCAV _run_single_set - param.concepts')
   # print(concepts)
    target_class = param.target_class
   # print('I am in TCAV _run_single_set - param.target_class')
